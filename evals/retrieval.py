...
Usage:
    python -m evals.run_evals --agent vanilla --k 5 10 15
    python -m evals.run_evals --agent multi-query --num-samples 10
...
Examples:
  ...
  python -m evals.run_evals --agent vanilla --num-samples 10

  # Custom retrieval settings
  python -m evals.run_evals --fts-candidates 200 --max-returned 20
        """,
    )
